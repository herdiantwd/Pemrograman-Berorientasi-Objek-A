# Latihan Group Object

Pada pertemuan ke-6 ini diberikan sebuah materi tentang `Grouping Object` dan latihan untuk menganalisis program `Project Organizer`. Terdapat 2 class yang dibuatdalam
program tersebut yaitu :

1. Task (Untuk mengatur isi dari tugas ynag dibuat)
2. PersonalOrganizer (Sebagai menu utama program dan _collecting_ tugas-tugas yang dibuat)
